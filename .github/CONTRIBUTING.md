...
* Create an [issue](https://github.com/jonnitto/Jonnitto.Smartlook/issues) on GitHub, if you have found a bug
...
* Submit an [issue](https://github.com/jonnitto/Jonnitto.Smartlook/issues), assuming one does not already exist.
